	...
	<body>
		<div class="row">
			...
			<ol class="list-inline" style="padding:10px 15px;">
	  				...
	  				<li><button type="button" onclick="window.open('exportPdf/migrantMarried?formNo=${formNo}')" class="btn btn-link"><i class="glyphicon glyphicon-file"></i>导出pdf</button></li>
				</ol>	
			</div>
		</div>
			...
			<div class="col-xs-6 col-md-6 col-lg-6" style="margin-right:7px;border:1px solid #BBBBBB;min-height:600px;background-color:white;">
				...
				<div class="col-xs-12 col-md-12 col-lg-12" style="margin-top:7px;margin-bottom:7px;">
					<div class="col-xs-12 col-md-12 col-lg-12">
						现有子女数: <span id="formChildFirst" style="margin-right:15px;"><em style="color:#787778;">数据加载中...</em></span>
						男孩: <span id="formChildSecond" style="margin-right:15px;"><em style="color:#787778;">数据加载中...</em></span>
						女孩: <span id="formChildThird"><em style="color:#787778;">数据加载中...</em></span>
					</div>
				</div>
				...
				<div class="col-xs-12 col-md-12 col-lg-12" style="margin-top:7px;margin-bottom:7px;">
					<div class="col-xs-12 col-md-12 col-lg-12">
						夫妇是否外出: <span id="formCoupleOut" style="margin-right:15px;"><em style="color:#787778;">数据加载中...</em></span>
				...
				<!-- 	<div class="col-xs-2 col-md-2 col-lg-2" style="padding-right:0px;">
					...
					<div class="col-xs-12 col-md-12 col-lg-12">
						是否进行节育措施: <span id="formBirthControl" style="margin-right:15px;"><em style="color:#787778;">数据加载中...</em></span>
						<span id="formBirthControlSpan" style="margin-left:7px;">节育类型: <span id="formBirthControlType" style="margin-right:15px;"><em style="color:#787778;">数据加载中...</em></span></span>
