...
//                    },
                    ...
                    formatter: function (value, row, index) {
                    	...
                    	var lookUp = '<div class="btn-group"><a class="glyphicon glyphicon-list-alt" style="cursor: pointer;" onclick="lookUpPoll(\'' + title + '\',' + row.id + ')"></a></div>';
                        if (row.status == 1) {
                            ...
                            var edit = '<div class="btn-group"><a class="glyphicon glyphicon-edit" style="cursor: pointer;" onclick="editPoll(' + row.id + ')"' + '></a></div>';
        ...
        $("#del_survey").off("click").on("click", function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#topic_list').bootstrapTable('refresh');
                    $("#confirm_delete_survey").modal("hide");
